...
export default function App() {
  ...
  const [uploadedImage1, setUploadedImage1] = useState<string | null>(() => {
    try {
      return localStorage.getItem('uploadedImage1');
    } catch {
      return null;
    }
  });
  const [uploadedImage2, setUploadedImage2] = useState<string | null>(() => {
    try {
      return localStorage.getItem('uploadedImage2');
    } catch {
      return null;
    }
  });
  const [uploadedImage3, setUploadedImage3] = useState<string | null>(() => {
    try {
      return localStorage.getItem('uploadedImage3');
    } catch {
      return null;
    }
  });
  const [uploadedImage4, setUploadedImage4] = useState<string | null>(() => {
    try {
      return localStorage.getItem('uploadedImage4');
    } catch {
      return null;
    }
  });
  ...
  useEffect(() => {
    try {
      if (uploadedImage1) localStorage.setItem('uploadedImage1', uploadedImage1);
    } catch (e) {
      console.error(e);
    }
  }, [uploadedImage1]);
  ...
  useEffect(() => {
    try {
      if (uploadedImage2) localStorage.setItem('uploadedImage2', uploadedImage2);
    } catch (e) {
      console.error(e);
    }
  }, [uploadedImage2]);
  ...
  useEffect(() => {
    try {
      if (uploadedImage3) localStorage.setItem('uploadedImage3', uploadedImage3);
    } catch (e) {
      console.error(e);
    }
  }, [uploadedImage3]);
  ...
  useEffect(() => {
    try {
      if (uploadedImage4) localStorage.setItem('uploadedImage4', uploadedImage4);
    } catch (e) {
      console.error(e);
    }
  }, [uploadedImage4]);
            ...
            <div className="w-full max-w-6xl mx-auto py-12 space-y-24 sm:space-y-32">
              ...
              <section id="chapter-01" className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 pt-8 scroll-mt-28">
                <div className="lg:col-span-5 flex flex-col justify-start">
                  ...
                  <ImageUploader 
                    ...
                    title="CHAPTER 01 / STAMP OR ARTWORK"
                    description="Select or drag a premium high-fidelity Japanese washi stamp or loop graphic."
                  />
              ...
              <section id="chapter-02" className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 border-t border-neutral-900 pt-16 scroll-mt-28">
                <div className="lg:col-span-5 flex flex-col justify-start">
                  ...
                  <ImageUploader 
                    ...
                    onChange={setUploadedImage2}
                    title="CHAPTER 02 / CONTROL MATRIX GRAPHIC"
                    description="Select or drag a diagrammatic matrix or schematic layout."
                  />
                  <p className="text-neutral-400 font-mono text-xs tracking-widest uppercase mt-4 max-w-sm leading-relaxed">
              ...
              <section id="chapter-03" className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 border-t border-neutral-900 pt-16 scroll-mt-28">
                <div className="lg:col-span-5 flex flex-col justify-start">
                  ...
                  <ImageUploader 
                    id="washi-craft-stamp"
                    value={uploadedImage3}
                    onChange={setUploadedImage3}
                    title="CHAPTER 03 / HIGHEST-RES TEXTURE"
                    description="Upload an 8K texture or premium organic fiber image."
                  />
                </div>
              ...
              <section id="chapter-04" className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 border-t border-neutral-900 pt-16 scroll-mt-28">
                <div className="lg:col-span-5 flex flex-col justify-start">
                  ...
                  <ImageUploader 
                    id="longevity-symmetry-stamp"
                    value={uploadedImage4}
                    onChange={setUploadedImage4}
                    title="CHAPTER 04 / SYMMETRIC MOTIF"
                    description="Upload a continuous repeating motif or symmetric pattern design."
                  />
                </div>
